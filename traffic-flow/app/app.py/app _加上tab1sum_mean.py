...
# ---- 讀原始 LSTM（每小時 per-hour 值），直接聚合到 zone ----
def lstm_raw_zone_values(day_abs: int, period: str, agg_mode: str) -> pd.Series | None:
    ...
    # 期望欄位：day (232..252), from (0..5), to (0..5), value
...
with tab1:
    ...
    # OBS / ARIMA / TensorTS 一律用 period 檔，遵守 stat1
